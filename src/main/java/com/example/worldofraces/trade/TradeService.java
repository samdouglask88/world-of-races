package com.example.worldofraces.trade;
...
public final class TradeService {
    ...
    public static Result buy(ServerPlayer player, RaceEntity npc, int stockSlot, int amount) {
    ...
    public static Result sell(ServerPlayer player, RaceEntity npc, int playerSlot, int amount) {
    ...
    private static boolean valid(ServerPlayer player, RaceEntity npc, int amount) {
